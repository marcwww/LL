...
def model_opts(parser):
    ...
    group.add_argument('-capacity', type=int, default=300000)
    # group.add_argument('-add_per', type=int, default=320)
    group.add_argument('-bsz_sampling', type=int, default=3)
...
def train_opts(parser):
    ...
    group.add_argument('-name', type=str, default='rammlp_add-per-10')
    ...
    # group.add_argument('-name', type=str, default='gsmlp')
    ...
    # group.add_argument('-net', type=str, default='gsmlp')
    ...
    group.add_argument('-test_per_ratio', type=float, default=1)